...
execute if score #sell_total skyblock_temp matches 1.. run title @s actionbar [{"text":"Sold! +","color":"gray"},{"score":{"name":"@s","objective":"skyblock_last_sale"},"color":"gold"},{"text":" coins","color":"gold"}]
